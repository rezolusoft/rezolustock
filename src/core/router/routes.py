...
routes = {
    ...
    "/on_shop_register": Route(path="/on_shop_register", module="pages.onboarding.on_shop_register", view="on_shop_register", requires_root=True,  layout="onboarding"),
    "/on_add_password": Route(path="/on_add_password", module="pages.onboarding.on_add_password", view="on_add_password", requires_root=True,  layout="onboarding"),
    "/on_add_category": Route(path="/on_add_category", module="pages.onboarding.on_add_category", view="on_add_category", requires_root=True,  layout="onboarding"),
    "/on_add_product": Route(path="/on_add_product", module="pages.onboarding.on_add_product", view="on_add_product", requires_root=True,  layout="onboarding"),
